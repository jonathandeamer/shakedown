...
ACT: Act = act(
    ...
    [
        ...
        scene(
            ...
            branch(eq(val(HORATIO), const(4)), then="PASS_CODE_OPEN"),
        ...
        scene(
            "PASS_CODE_GATE_READ",
            *_read(),
            branch(eq(val(HECATE), _SPACE), then="PASS_CODE_CONTINUE"),
            goto("PASS_HR_SAVE"),
            companion=HECATE,
        ),
        scene(
        ...
        scene(
            ...
            *_read(),
            branch(eq(val(HECATE), _NEWLINE), then="PASS_CODE_CLOSE"),
            goto("PASS_HR_REPLAY"),
            companion=HECATE,
        ),
        scene(
        ...
        scene(
            "PASS_BLOCK_REPLAY",
            pop(MACBETH, recall="staged_stone"),
            branch(eq(val(MACBETH), const(tokens.TEXT_END)), then="PASS_BLOCK_FINISH"),
            push(LADY_MACBETH, val(MACBETH)),
            goto("PASS_BLOCK_REPLAY"),
            companion=MACBETH,
        ),

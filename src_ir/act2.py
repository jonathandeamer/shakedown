...
ACT: Act = act(
    ...
    [
        ...
        scene(
            "PASS_QUOTE_EOF_GATE",
            branch(eq(val(HORATIO), const(1)), then="PASS_QUOTE_EOF_CLOSE"),
            goto("PASS_LISTS_DONE"),
            companion=HORATIO,
        ),
        scene(
            "PASS_QUOTE_EOF_CLOSE",
            pop(LADY_MACBETH, recall="code_chamber_mark"),
            push(LADY_MACBETH, const(tokens.TEXT_END)),
        ...
        scene(
            ...
            push(LADY_MACBETH, const(tokens.TEXT_END)),
            push(LADY_MACBETH, const(tokens.BLOCKQUOTE_CLOSE)),
            branch(gt(val(HORATIO), const(1)), then="PASS_QUOTE_LIST_BLANK"),
            let(HORATIO, const(0)),
        ...
        scene(
            "PASS_QUOTE_PREFIX",
            *_read(),
            branch(eq(val(HECATE), _SPACE), then="PASS_QUOTE_PREFIX_OPTIONAL"),
        ...
        scene(
            ...
            push(LADY_MACBETH, const(tokens.TEXT_END)),
            push(LADY_MACBETH, const(tokens.BLOCKQUOTE_CLOSE)),
            branch(gt(val(HORATIO), const(1)), then="PASS_QUOTE_LIST_CLEAR"),
            goto("PASS_HR_GATE"),
            companion=HECATE,
        ),
        scene(
        ...
        scene(
            ...
            *_read(),
            ...
            branch(eq(val(HECATE), _TAB), then="PASS_QUOTE_FINISH_OPTIONAL"),

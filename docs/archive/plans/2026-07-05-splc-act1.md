...
- [x] **Step 3: Implement the IR module**
...
- [x] **Step 3: Implement the prose engine**
...
- [x] **Step 2: Create the render CLI**
...
- [x] **Step 3: Write the generated-fragment contract test**
...
- [x] **Step 4: Capture the BEFORE token-stream snapshot (gate G2 baseline)**
...
- [x] **Step 5: Render Act I and rebuild the play**
...
- [x] **Step 6: Run gate G2 — token-stream equality**
...
- [x] **Step 7: Run gate G1 — strict fixture parity**
...
- [x] **Step 8: Run the named literary/regression gates**
...
- [x] **Step 9: Run gate G3 — full default suite**
...
- [x] **Step 2: Run the roadmap and protocol contract tests**

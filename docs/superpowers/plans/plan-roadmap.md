...
2 is halted on 2026-07-14 for the sole in-flight MCO governance recovery
(row 5R); no Markdown implementation may resume until that recovery ships and
an interactive planning decision explicitly reinstates or replaces Slice 2.

...
| 6 | Slice 3 — Medium-risk fixtures (`docs/superpowers/plans/2026-07-14-slice-3-medium-risk-fixtures.md`) | §7.6 | ~10 fixtures pass: Hard-wrapped paragraphs with list-like lines; Links (inline, reference, shortcut); Images; Literal quotes in titles; Strong and em together; Inline HTML (Simple); Inline HTML comments; Blockquotes with code blocks | §8.1 four-gate per fixture; spike snippets still pass | in flight |

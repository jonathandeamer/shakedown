...
| 7 | Slice 4 — High-risk fixtures (`docs/superpowers/plans/2026-07-17-slice-4-high-risk-fixtures.md`) | §7.7 | Three fixtures pass: Inline HTML (Advanced); Nested blockquotes (full); Ordered and unordered lists (full) | §8.1 four-gate per fixture; spike snippets still pass | in flight |

...
2026-07-06. Execution is staged as P1 (row 3K, tokenized stream + dispatcher
skeleton, plan written 2026-07-06) then P2 (row 3L, list pass — plan written
only after 3K ships), with Spike B (row 4) following P2.
